...
import { Shield, PiggyBank, AlertCircle, TrendingUp } from 'lucide-react';
        ...
        <FAQSection
          ...
          faqs={[
            ...
            },
            {
              ...
              answer: "Kontrolujte ročně nebo při větších životních změnách: zvýšení příjmů/výdajů, narození dítěte, koupě nemovitosti, změna zaměstnání, rozwoj nebo nemoc. Rezerva má odpovídat vaší aktuální životní situaci a rizikovému profilu."
            }
          ]}
          className="mt-16"
        />
