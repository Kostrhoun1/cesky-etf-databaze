...
const FedSnizilSazbyETFAnalyza2025: React.FC = () => {
  ...
  return (
    <BlogArticleLayout
      ...
      seoDescription="Fed snížil úrokové sazby o 0,25% - analýza dopadu na ETF fondy září 2025. Gold mining ETF +91%, bankovní sektor +64%, krypto blockchain ETF +46%. Investiční doporučení a výhled trhů."
      readTime="12 min"
      ...
      <Card className="mt-8 bg-gradient-to-r from-violet-500 to-purple-600 text-white">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Link to="/tipy/nejlepsi-dividendove-etf" className="block hover:underline">
