...
const BlogPage: React.FC = () => {
  const blogSchema = {
    ...
    "description": "Chytré tipy a srovnání ETF fondů pro české investory",
  ...
  return (
    <Layout>
      <SEOHead
        ...
        keywords="ETF tipy, nejlepší ETF 2025, dividendové ETF, americké ETF, evropské ETF, NASDAQ ETF, investiční strategie"
        schema={blogSchema}
      />
