  ...
  <section className="bg-white py-14">
    <div className="max-w-6xl mx-auto px-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-7">
        {usp.map((item) =>
          <Card key={item.title} className="flex flex-col items-center text-center py-8 px-4 border-transparent shadow-none hover:shadow-md transition-shadow duration-200 group bg-white">
            <div className="mb-4 flex items-center justify-center rounded-full bg-violet-100 w-14 h-14 group-hover:bg-violet-200 transition-colors">
              <item.icon className="h-7 w-7 text-violet-700" aria-hidden="true" />
            </div>
