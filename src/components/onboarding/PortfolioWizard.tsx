...
import { ArrowRight, Sparkles, Target, TrendingUp, Shield, Clock, Home, GraduationCap, PiggyBank, ExternalLink } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: "Vytvoříme pro vás ideální portfolio za 3 minuty",
      content: (
        <div className="text-center space-y-6">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2">Moderní portfolio management</h3>
            <p className="text-gray-600">
              Sestavíme vám profesionální portfolio podle vědeckých principů diverzifikace,
              stejně jako používají světové investiční společnosti.
            </p>
          </div>
    ...
    },
    {
      ...
      description: "Personalizované portfolio na míru vašemu profilu",
      content: recommendation ? (
        <div className="space-y-6">
                ...
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      <Link 
                        to={`/etf/${etf.isin}?from=portfolio`}
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <h4 className="font-semibold mb-2">Proč toto portfolio?</h4>
  ...
  const handleNext = async () => {
    if (currentStep < steps.length - 1) {
      ...
      if (recommendation) {
        ...
        navigate(`/srovnani-etf?portfolio=${isins}&wizard=portfolio`);
      }
      onClose?.();
    }
  };
            ...
            <div className="flex gap-3">
              <Button 
                onClick={() => {
                  if (recommendation) {
                    const isins = recommendation.etfs.map(etf => etf.isin).join(',');
                    navigate(`/srovnani-etf?compare=${isins}&portfolio=true`);
                  }
                }}
                variant="outline"
